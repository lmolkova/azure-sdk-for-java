...
class VertxAsyncHttpClient implements HttpClient {
    ...
    public Mono<HttpResponse> send(HttpRequest request, Context context) {
        ...
        Future<HttpClientRequest> futureRequest = toVertxHttpRequest(request);

        return Mono.create(sink -> {
            Future<HttpResponse> futureResponse = futureRequest.compose(vertxHttpRequest -> {
    ...
    private Future<HttpClientRequest> toVertxHttpRequest(HttpRequest request) {
