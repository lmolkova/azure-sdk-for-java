...
class ValueLocatorUtils
{
    ...
    /**
     * All kinds of {@link Map}s.
     */
    public final static int SER_MAP = 1;

    /**
     * All kinds of {@link List}s.
     */
    public final static int SER_LIST = 2;

    /**
     * All kinds of {@link Collection}s other than {@link List}s
     */
    ...
    /**
     * An implementation of {@link TreeNode}
     */
    ...
    public static int _findSimpleType(Class<?> raw, boolean forSer)
    {
        if (raw == String.class) {
            return SER_STRING;
        }
