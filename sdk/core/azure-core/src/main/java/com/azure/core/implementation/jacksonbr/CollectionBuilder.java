...
public abstract class CollectionBuilder
{
    ...
    protected CollectionBuilder(Class<?> collImpl) {
     ...
     * as the type of {@link List} to build, unless instructed otherwise.
     *<p>
     * When sub-classing to use different underlying mutable {@link List}
     * type, you need to sub-class following methods:
     *<ul>
     * <li>{@link #newBuilder}: factory method for constructing new builder instance
     *  </li>
     * <li>{@link #_list}: factory method for constructing {@link List} to build
     *  </li>
     *</ul>
     *<p>
    ...
    public static class Default extends CollectionBuilder
    {
        ...
        protected Default(Class<?> collImpl) {
            super(collImpl);
        }
